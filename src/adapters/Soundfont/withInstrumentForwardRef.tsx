...
export function withInstrument<Tprops extends InjectedProps = InjectedProps>(
  ...
  type 1ComponentInstance = InstanceType<typeof WrappedComponent>;
  type withForwaredRef = ProviderProps & { forwardRef: Ref<ComponentInstance> };
  ...
  > {
    ...
    constructor(props: withForwaredRef) {
      super(props);
